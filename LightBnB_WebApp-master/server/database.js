...
const getAllProperties = function (options, limit = 10) {
  ...
  if (options.minimum_price_per_night) {
    ...
    queryString += `${queryParams.length === 1 ? 'WHERE' : 'AND'} cost_per_night/100 > $${queryParams.length}`;
  }
...
const addProperty = (property) => {
  ...
  return pool.query(sqlQuery, [owner_id, title, description, thumbnail_photo_url, cover_photo_url, cost_per_night, street, city, province, post_code, country, parking_spaces, number_of_bathrooms, number_of_bedrooms])
}
